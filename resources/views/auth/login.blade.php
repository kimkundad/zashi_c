				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="sign-in-form">
							<h3>Sign In</h3>
							<form role="form" id="my_form" method="POST" action="{{url('login')}}">
                {{ csrf_field() }}
								<div class="row">
									<div class="col-md-12">
										<div class="single-input">
											...
											<div class="form-group">
												<input type="text" class="form-control" placeholder="Username or e-mail" name="email" aria-label="Name">
											</div>
										</div>
									</div>
									<div class="col-md-12">
									...
									<div class="col-md-12">
										<div class="sign-in-btn">
											...
											<a href="javascript:{}" onclick="document.getElementById('my_form').submit();" class="btn-small"> Sign In </a>

											<h4>Don’t have an account? <a href="{{url('register')}}"> Create one here!</a></h4>
										</div>
									</div>
								</div>
							</form>
