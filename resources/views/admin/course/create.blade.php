                        ...
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                <input type="text" class="form-control " name="c_name" value="{{ old('c_name')}}" placeholder="หัวข้อเรื่อง" required/>
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                <input type="text" class="form-control " name="c_title" value="{{ old('c_title')}}" placeholder="Dream 1, N1" required/>
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                <input type="text" class="form-control " name="c_time_study" value="{{ old('c_time_study')}}" placeholder="ตลอด 24 ชม." required/>
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                <input type="text" class="form-control " name="youtube_course" value="{{ old('youtube_course')}}" placeholder="https://www.youtube.com/watch?v=2Ga7atYDjTg" required/>
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                <input type="text" class="form-control " name="url_course" value="{{ old('url_course')}}" placeholder="https://learnsbuy.com/courseinfo/14" required/>
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                <input type="text" class="form-control " name="c_price" value="{{ old('c_price')}}" placeholder="1000" required/>
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                <input type="text" class="form-control " name="c_discount" value="{{ old('c_discount')}}" placeholder="1000"/>
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                <input type="text" class="form-control " name="c_student" value="{{ old('c_student')}}" placeholder="500" required/>
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                <textarea class="form-control" id="summernote" rows="4" name="c_detail" placeholder="ใส่ข้อมูลรายละเอียดเบื้องต้น..." rows="8" >{{ old('c_detail') }}</textarea>
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                <textarea class="form-control" id="summernote2" rows="4" name="c_course" placeholder="ใส่ข้อมูลเนื้อหาคอร์ส..." rows="8" >{{ old('c_course') }}</textarea>
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                <textarea class="form-control" id="summernote3" rows="4" name="c_video" placeholder="ใส่ข้อมูล Video คอร์ส..." rows="8" >{{ old('c_video') }}</textarea>
                              </div>
                            </div>
                          </div>
