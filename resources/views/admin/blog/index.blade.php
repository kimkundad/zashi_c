...
<div class="row">
  <div class="col-lg-12 grid-margin stretch-card">
    ...
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">{{$datahead}} <button type="button" onclick="window.location.href='{{url('admin/blog/create')}}'"
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td >
                      ...
                      <button type="button" style="float: left;padding: 10px; margin-left: 10px;" onclick="window.location.href='{{url('admin/blog/'.$u->id.'/edit')}}'"  class="btn btn-icons btn-rounded btn-outline-warning"><i class="icon-settings"></i></button>
