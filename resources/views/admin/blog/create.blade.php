                        ...
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                <input type="text" class="form-control " name="blog_title" value="{{ old('blog_title')}}" placeholder="หัวข้อเรื่อง" required/>
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                <textarea class="form-control" id="summernote" rows="4" name="blog_detail" placeholder="ใส่ข้อมูลรายละเอียดของช่างเบื้องต้น..." rows="8" required>{{ old('tech_detail') }}</textarea>
                              </div>
                            </div>
                          </div>
